...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-slate-50 to-indigo-50 flex flex-col">
      {/* Header */}
      <header className="border-b border-slate-200/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/signup" className="px-5 py-2 rounded-lg text-white text-sm font-bold hover:shadow-lg transition-shadow" style={{ background: 'linear-gradient(90deg, #00BFA6 0%, #5C6AC4 100%)' }}>
              Get started free
            </Link>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-100/60 border border-teal-200/50 mb-6">
              <span className="text-sm font-bold text-teal-700">✨ AI-Powered Reviews</span>
            </div>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-tight mb-6">
              ...
              <span className="bg-clip-text text-transparent" style={{ background: 'linear-gradient(90deg, #00BFA6 0%, #5C6AC4 100%)' }}> in seconds</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link 
              href="/signup" 
              className="px-8 py-4 rounded-xl text-white font-bold text-lg hover:shadow-xl transition-shadow"
